...
define('finalproject/routes/search', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({
    ...
    model: function model() {
      ...
      var getResults = function getResults(userSearch) {
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["content", "d", ["loc", [null, [8, 4], [8, 9]]], 0, 0, 0, 0]],
        locals: ["d"],
        templates: []
      };
    })();
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el1, "id", "userSearch");
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("input");
        ...
        dom.setAttribute(el1, "onclick", "getResults(document.getElementById('userSearch'))");
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n\n");
        dom.appendChild(el0, el1);
        var el1 = dom.createComment("");
      ...
      statements: [["block", "each", [["get", "model", ["loc", [null, [7, 8], [7, 13]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [7, 0], [9, 9]]]], ["content", "outlet", ["loc", [null, [11, 0], [11, 10]]], 0, 0, 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
